...
% \noindent Here $p(k) = \{ b_{k} \in \mathbb{B} \mid \langle \ldots, b_{k}, \ldots \rangle \in p \}$, that is, the set of every $k$-th element in $p$.
% \{ \langle b_{1}, b_{2}, b_{3}, b_{4} \rangle \in \mathbb{B}^{4} \mid b_{3} = \cap p_{1} \wedge \cap p_{2}, b_{4} = \neg (\cap p_{3}) \}
