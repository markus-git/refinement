...
\noindent If we apply $\hat{\mathcal{M}}$ to the join of $\langle 0, 1, \X \rangle$ and $\langle 1, 0, \X \rangle$, or if we apply $\hat{\mathcal{M}}$ individually and then join them, we get two different results:
