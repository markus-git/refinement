...
%% In the case of $\mathbb{T}_{\bot}^{3}$ and the unit-delayed AND gate, for example, $\Out(\cdot)$ could be defined as a regular projection ...
...
% As $\Out(\cdot)$ is not limited to projections, however, one could also define other interesting mappings. For instance, 
