...
%% \begin{lemma}
%% $\upsilon \in \gamma(\Consequent(\rho)) \wedge \Vis(\tau) \ll \Vis(\upsilon) \implies \tau \in \Consequent(\rho)$
%% \end{lemma}

%% First, $\Vis(\tau) \ll \Vis(\upsilon) \iff \Vis(\tau) \subseteq \gamma(\Vis(\upsilon))$.

%% $\qedbox$

\begin{lemma}
$\tau \in \gamma(\Antecedent(\rho)) \wedge \Vis(\tau) \ll \Vis(\upsilon) \implies \upsilon \in \Antecedent(\rho)$
\end{lemma}
