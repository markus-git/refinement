...
% Applying this lemma, then, we must have that $(\hat M(\hat \iota \sqcap \hat p_{1}) \sqcup \hat M(\hat \iota \sqcap \hat p_{2})) \enc \, (\hat N(\hat \iota \sqcap \hat q_{1}) \sqcup \hat N(\hat \iota \sqcap \hat q_{2}))$ for all $\hat \iota \in \hat I$.
