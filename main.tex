...
% Refinement ...
\newcommand{\out}[1]{\llbracket#1\rrbracket} % output projection.
\DeclareMathOperator{\I}{\mathit{i}} % input proj.
\renewcommand{\O}{\mathit{o}} % output proj.
\DeclareMathOperator{\enc}{\preceq} % encodes.
\DeclareMathOperator{\Driv}{\textit{Driv}} % set of drivers.
