...
\newcommand{\Traj}{\textit{Traj}} % set of trajectories
...
% Refinement ...
\newcommand{\InProj}{\mathit{i}} % input proj.
\newcommand{\OutProj}{\mathit{o}} % output proj.
\newcommand{\out}[1]{\llbracket#1\rrbracket} % output mapping.
\DeclareMathOperator{\enc}{\preceq} % encodes.
\newcommand{\Driv}{\textit{Traj}} % trajectory induced by driver.
